...
## Integration & Interoperability（集成与互操作）

| ADR | Status | Date | Title | Layer |
|-----|--------|------|-------|-------|
| ADR-0017 | Experimental | 2026-07-11 | Cross-Engine Trace & Workflow Inheritance | L2 Engine |
| ADR-0018 | Experimental | 2026-07-11 | Engine Scheduling | L2 Engine |
...
> **状态说明**：Experimental = 已实现但尚未经多实例验证，不可视为平台基线。
>
